...
import { ArrowRight, ChevronRight, Coins, Gift, Shield, Sparkles, Star, TrendingUp, Trophy, Users, Zap } from "lucide-react"
...
const stats = [
  { label: "Total Volume", value: "2.4M SUI", change: "+12.5%" },
  { label: "Active Lotteries", value: "47", change: "+8" },
  { label: "Successful Loans", value: "892", change: "+23%" },
  { label: "Happy Users", value: "3.2K", change: "+156" }
]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-1/2 -left-1/2 w-full h-full bg-gradient-radial from-purple-500/20 via-transparent to-transparent animate-pulse" />
        <div className="absolute -bottom-1/2 -right-1/2 w-full h-full bg-gradient-radial from-blue-500/20 via-transparent to-transparent animate-pulse" style={{ animationDelay: '1s' }} />
        <div className="absolute top-1/4 right-1/3 w-2 h-2 bg-amber-400 rounded-full animate-ping" style={{ animationDelay: '2s' }} />
        <div className="absolute bottom-1/3 left-1/4 w-1 h-1 bg-purple-400 rounded-full animate-ping" style={{ animationDelay: '3s' }} />
        <div className="absolute top-2/3 left-3/4 w-1.5 h-1.5 bg-blue-400 rounded-full animate-ping" style={{ animationDelay: '4s' }} />
      </div>

      {/* Hero Section */}
      <section className={cn(
        "relative z-10 px-6 pt-32 pb-20 transition-all duration-1000",
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-6xl md:text-8xl font-bold mb-8 bg-gradient-to-r from-amber-400 via-purple-400 to-pink-500 bg-clip-text text-transparent leading-tight">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 mb-16">
            <Link href="/lotteries">
              <button className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold px-8 py-4 text-lg rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 group flex items-center">
            ...
            <Link href="/profile">
              <button className="border border-amber-300/50 text-amber-300 hover:bg-amber-300/10 px-8 py-4 text-lg font-semibold backdrop-blur-sm transition-all duration-300 rounded-full">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center group">
              ...
              <h3 className="text-2xl font-semibold mb-4 text-white">Create Lottery</h3>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-2xl font-semibold mb-4 text-white">Buy WonkaBars</h3>
              <p className="text-white/80 leading-relaxed">
            ...
            <div className="text-center group">
              <div className="w-20 h-20 rounded-full bg-gradient-to-br from-green-500 to-emerald-500 flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:shadow-2xl group-hover:shadow-green-500/25 transition-all duration-300">
                <span className="text-2xl font-bold text-white">3</span>
              </div>
              <h3 className="text-2xl font-semibold mb-4 text-white">Everyone Wins</h3>
              <p className="text-white/80 leading-relaxed">
                Repay to keep your NFT, or let lottery conclude. Winners get NFTs, others get ChocoChips. Everyone benefits!
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="bg-gradient-to-br from-purple-600/20 to-pink-600/20 rounded-2xl p-8 border border-white/10">
              ...
              <div className="space-y-6">
                <div className="bg-green-500/20 rounded-lg p-6 border border-green-500/30">
                  <h4 className="font-semibold text-green-300 mb-3">📈 Successful Repayment</h4>
                ...
                <div className="bg-purple-500/20 rounded-lg p-6 border border-purple-500/30">
                  <h4 className="font-semibold text-purple-300 mb-3">📉 Lottery Conclusion</h4>
                  <ul className="space-y-2 text-sm text-white/80">
      ...
      <section className="relative z-10 px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            <Link href="/lotteries">
              <button className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold px-8 py-4 text-lg rounded-full shadow-2xl hover:shadow-purple-500/25 transition-all duration-300 group flex items-center">
            ...
            <Link href="https://docs.meltyfi.com" target="_blank">
              <button className="border border-white/30 text-white hover:bg-white/10 px-8 py-4 text-lg font-semibold backdrop-blur-sm transition-all duration-300 rounded-full">
                Learn More
              </button>
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex items-center space-x-8 text-white/60">
              ...
              <Link href="https://discord.gg/meltyfi" target="_blank" className="hover:text-white transition-colors">Discord</Link>
              <Link href="https://twitter.com/meltyfi" target="_blank" className="hover:text-white transition-colors">Twitter</Link>
            </div>
          </div>
